import { T as LiveContentConfigError, tt as AstroError } from "./errors-data-D0npprzN.js";
import { t as v4_exports } from "./v4-Bstt7Be_.js";
...
//#endregion
//#region ../node_modules/astro/dist/virtual-modules/live-config.js
function createErrorFunction(message) {
	return () => {
		const error = /* @__PURE__ */ new Error(`The ${message}() function is not available in live config files.`);
...
var getCollection = createErrorFunction("getCollection");
var render = createErrorFunction("render");
var getEntry = createErrorFunction("getEntry");
var getEntries = createErrorFunction("getEntries");
var reference = createErrorFunction("reference");
var getLiveCollection = createErrorFunction("getLiveCollection");
var getLiveEntry = createErrorFunction("getLiveEntry");
var defineCollection = createErrorFunction("defineCollection");
//#endregion
export { defineCollection, defineLiveCollection, getCollection, getEntries, getEntry, getLiveCollection, getLiveEntry, reference, render, v4_exports as z };
